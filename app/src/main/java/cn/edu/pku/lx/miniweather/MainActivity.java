...
import cn.edu.pku.lx.app.MyApplication;
import cn.edu.pku.lx.bean.City;
import cn.edu.pku.lx.bean.FutureWeather;
import cn.edu.pku.lx.bean.TodayWeather;
import cn.edu.pku.lx.service.UpdateService;
import cn.edu.pku.lx.util.NetUtil;
    ...
    void updateTodayWeather(TodayWeather todayWeather) {
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            for (int j = 0; j < view.getChildCount(); j++) {
                ...
                ((ImageView) subview.findViewById(R.id.weather_img)).setImageResource(weatherRes.get(futureWeather.getType()));
